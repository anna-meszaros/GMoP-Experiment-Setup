...
import torch
import random
from GMoP_jointPreTrainInter.flowModels import GMoP, Future_Encoder, Future_Decoder, Future_Seq2Seq, Scene_Encoder, InteractionClassifier
from GMoP_jointPreTrainInter.LaneGCN import from_numpy

from GMoP_jointPreTrainInter.multi_task_utils import get_crossing_trajectories, get_hypothetical_path_crossing

import pandas as pd
import pickle
import os

class GMoP_meszaros_jointPreTrainInter(model_template):
    '''
    ...
    def get_name(self = None):
        ...
        model_str = 'GMoP_jointPreTrainInter_' + kwargs_str 
