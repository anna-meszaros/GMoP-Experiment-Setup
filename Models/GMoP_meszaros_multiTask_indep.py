...
import torch
import random
from GMoP_multiTask_Indep.flowModels import GMoP, Future_Encoder, Future_Decoder, Future_Seq2Seq, Scene_Encoder
from GMoP_multiTask_Indep.LaneGCN import from_numpy

import pandas as pd
import pickle
import os

class GMoP_meszaros_multiTask_indep(model_template):
    '''
    ...
    def get_name(self = None):
        ...
        kwargs_str += 'seed' + str(self.model_kwargs['seed']) + '_' + \
                      ...
                      'es_gnn' + str(self.model_kwargs['es_gnn'])
        ...
        model_str = 'GMoP_multiTask_indep' + kwargs_str 
