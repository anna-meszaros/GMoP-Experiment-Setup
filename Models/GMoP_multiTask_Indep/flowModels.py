...
from GMoP_multiTask_Indep.spline_flow import NeuralSplineFlow
from GMoP_multiTask_Indep.SocialEncodingModule import SocialInterGNN
...
from GMoP_multiTask_Indep.dag_utils import dagification, kahn_toposort
from GMoP_multiTask_Indep.LaneGCN import M2A, MapNet, graph_gather, gpu, to_long
...
class GMoP(nn.Module):
    ...
    def __init__(self, pred_steps, alpha, beta, gamma, scene_encoder=None, B=15., 
                ...
                n_layers_gnn=4, es_gnn=64, T_all = None, lanegcn_configs=None):
