...
Data_sets = [{'scenario': 'Interaction_interactive', 'max_num_agents': None, 't0_type': 'all', 'conforming_t0_types': []}]

# Select the params for the datasets to be considered
Data_params = [{'dt': 0.1, 'num_timesteps_in': (10, 10), 'num_timesteps_out': (30, 30)}] 
...
M.to_excel("INTERACTION_Results.xlsx")
 
M_std['minADE6_joint'] = Std[:, 0]
M_std['minFDE6_joint'] = Std[:, 1]
M_std['KDE_NLL_joint'] = Std[:, 2]
 
M_std.to_excel("INTERACTION_Results_std.xlsx")